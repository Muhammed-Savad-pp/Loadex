...
load_route.post('/load', authenticateToken, checkRole('shipper'), loadController.postLoad.bind(loadController));
load_route.get('/', authenticateToken, checkRole('shipper'), loadController.fetchLoads.bind(loadController));
load_route.put('/load', authenticateToken, checkRole('shipper'), loadController.updateLoad.bind(loadController));
